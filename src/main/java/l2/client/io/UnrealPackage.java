...
import static l2.client.io.ByteUtil.*;
import static l2.client.io.UnrealPackage.ObjectFlag.*;
import static l2.client.util.CollectionsMethods.indexIf;
...
public class UnrealPackage implements AutoCloseable {
    ...
    public static UnrealPackage create(RandomAccess randomAccess, int version, int license) throws UncheckedIOException {
        ...
        upData.put(uuidToBytes(UUID.randomUUID()));
